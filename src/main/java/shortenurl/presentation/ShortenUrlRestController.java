package shortenurl.presentation;
...
import shortenurl.application.SimpleShortenUrlService;
...
public class ShortenUrlRestController {
	...
	public ResponseEntity<ShortenUrlCreateResponseDto> createShortenUrl(@Valid @RequestBody ShortenUrlCreateRequestDto requestDto)  {
	...
	public ResponseEntity<ShortenUrlInformationDto> getShortenUrlInformation( @PathVariable String shortenUrlKey) {
		ShortenUrlInformationDto informationDto = simpleShortenUrlService.getShortenUrlInformationByShortenUrlKey(shortenUrlKey);
	...
	public ResponseEntity<List<ShortenUrlInformationDto>> getAllShortenUrlInformation() {
		List<ShortenUrlInformationDto> informationDtoList = simpleShortenUrlService.getAllShortenUrlInformationDto();
